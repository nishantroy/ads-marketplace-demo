...
- Finding 2, real starvation: only the two cheapest tiers were genuinely starved, in both modes, at 69% and 2% unpaced and 14% and 0% paced. The lowest bidders only win once the tiers above them are out of budget or paced out; with pacing the strong bidders never exhaust, so the cheap tail never gets a turn.
